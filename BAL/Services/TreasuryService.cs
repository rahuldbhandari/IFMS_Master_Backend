...
namespace IFMS_Master_Backend.BAL.Services
{
    public class TreasuryService : ITreasuryService
    {
        ...
        {
            List<Treasury> allTreasuryData = (List<Treasury>)await _TresuryRepo.GetAllAsync();
        ...
        public async Task<bool> DeleteTreasury(int Id)
        {
            ...
            treasuryToDelete.IsDelete = true;
        ...
        {
            Treasury treasury = await _TresuryRepo.GetSingleAysnc(treasury => treasury.Id == Id && treasury.IsDelete == false);
